...
// Автоматическое создание комнаты при первой загрузке страницы со случайным словом
...
function checkRow() {
    ...
    // Возвращаем старую локальную проверку слова
    ...
    // Если слово есть в словаре, отправляем на сервер
